...
Çok Satanlar servisi bir kategoride sıfır ürün döndürürse normal kategori arama servisi aynı kategori kimliğiyle ve `BEST_SELLER` sırasıyla devreye girer. Sponsor mağaza kartları sonuç havuzuna eklenmez; yalnız servis içindeki kategori ürün dizisi kullanılır. Günlük/derin sayfa bütçesi korunur ve kurtarılan ürünler aynı ayrıntı ile ertesi gün stok karşılaştırma kuyruğuna alınır. İki kaynakta da ürün bulunmayan kategori raporda gerçek boş olarak kalır.
